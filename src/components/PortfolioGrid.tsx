...
const projects = [
  {
    id: "01",
    title: "Project Alpha — Brand & Web Experience",
    category: "Web Design / 3D Composition",
    description: "An immersive interactive web dashboard designed for an advanced AI analytics platform.",
    image: "/images/work01.jpg",
    tags: ["Next.js", "WebGL", "TailwindCSS"],
  },
  {
    id: "02",
    title: "Aura Flow — Visual Branding Identity",
    category: "Brand Strategy / Graphic Arts",
    description: "Dynamic fluid graphic identities designed for a premium creative studio and audio network.",
    image: "/images/work02.jpg",
    tags: ["Illustrator", "Cinema 4D", "Figma"],
  },
  {
    id: "03",
    title: "Luminary — Minimalist 3D Platform",
    category: "Interface Design / 3D Render",
    description: "Clean minimalist tech compositing and mockups for a next-gen digital hardware release.",
    image: "/images/work03.jpg",
    tags: ["3D Compositing", "Product Design", "Figma"],
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 md:mb-24 gap-6">
          ...
          <p className="max-w-md text-text-secondary text-sm md:text-base leading-relaxed">
            A curated selection of creative design works combining modern web aesthetics, brand storytelling, and interactive UI.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {projects.map((project) => (
            <article
              key={project.id}
              className="group glass-panel rounded-2xl overflow-hidden glass-panel-hover transition-all duration-500 flex flex-col h-full"
            >
              {/* Image Container */}
